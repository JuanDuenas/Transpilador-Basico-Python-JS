...
class Python3ParserListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by Python3Parser#statement.
    def enterStatement(self, ctx:Python3Parser.StatementContext):
        pass

    # Exit a parse tree produced by Python3Parser#statement.
    def exitStatement(self, ctx:Python3Parser.StatementContext):
        pass
